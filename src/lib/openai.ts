...
- location_confirmed: true somente se a bio OU os posts mencionarem EXPLICITAMENTE uma destas cidades: Florianópolis, São José, Palhoça, Biguaçu, Joinville ou Blumenau. Se a bio ou os posts não mencionarem explicitamente uma dessas cidades, atribua 0 pontos de localização (location_confirmed=false) e marque is_icp=false — mesmo que o restante do perfil pareça promissor. Não infira localização por DDD, sotaque, área de atuação, seguidores ou qualquer outro sinal indireto. "Santa Catarina"/"SC" sozinho NÃO basta — precisa ser uma das seis cidades. Sigla de entidade internacional (ex.: "ESC", "FESC" de European Society of Cardiology) NÃO é a sigla do estado. Menção a outra cidade/estado brasileiro (ex.: "São Paulo", "São José dos Campos") deve dar false.
