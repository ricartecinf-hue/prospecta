...
- location_confirmed: true somente se a bio OU os posts mencionarem literalmente uma destas cidades: Florianópolis, São José, Palhoça, Biguaçu, Joinville ou Blumenau. Se nenhuma dessas cidades aparecer, responda location_confirmed=false. O sistema atribuirá 0 pontos de localização e forçará is_icp=false, sem exceção, mesmo que o restante do perfil pareça promissor. Não infira localização pela fonte de prospecção, location_id, DDD, sotaque, área de atuação, seguidores ou qualquer outro sinal indireto. "Florianópolis" não pode ser substituída por apelidos; "Santa Catarina"/"SC" sozinho NÃO basta. Sigla de entidade internacional (ex.: "ESC", "FESC" de European Society of Cardiology) NÃO é a sigla do estado. Menção a outra cidade/estado brasileiro (ex.: "São Paulo", "São José dos Campos") deve dar false.
